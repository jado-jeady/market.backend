...
export const updateUser = async (req, res, next) => {
  try {
    ...
    // Let the model's beforeUpdate hook handle hashing,
    // just like beforeCreate does in register()
    if (updates.password) {
      updates.password_hash = updates.password; // plain text → hook will hash it
